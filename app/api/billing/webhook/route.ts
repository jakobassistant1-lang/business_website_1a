...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (outcome.funnel) void logEvent(outcome.funnel, user.id, { eventId: event.id, type: event.type, source: "webhook" });
...
const USER_SELECT = { id: true, stripeSubscriptionId: true, subscriptionStatus: true } as const;
